      ...
      <section ref={eventsSection.ref} className={`py-8 md:py-16 px-2 md:px-4 transition-all duration-1000 ${eventsSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="container mx-auto max-w-6xl px-0 md:px-4">
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            {filteredEvents.map((event, index) => <Card key={event.id} className="overflow-hidden transition-all duration-300 hover:-translate-y-2 bg-card border-border animate-fade-in hover:shadow-[0_8px_30px_-5px_hsl(var(--gold-main)/0.4)] hover:border-club-bronze/50" style={{
