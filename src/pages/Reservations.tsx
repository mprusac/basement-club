        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="mb-12">
            <div className="flex items-center justify-center gap-4 mb-8">
              <div className={`flex items-center gap-2 ${step === "section" ? "text-primary" : step === "table" || step === "details" ? "text-primary" : "text-muted-foreground"}`}>
                <div className={`w-10 h-10 rounded-full flex items-center justify-center border-2 ${step === "section" ? "border-primary bg-primary text-primary-foreground" : "border-primary bg-primary/20"}`}>1</div>
                <span className="font-medium">Sektor</span>
              </div>
              <div className={`h-0.5 w-16 ${step === "table" || step === "details" ? "bg-primary" : "bg-border"}`} />
              <div className={`flex items-center gap-2 ${step === "table" ? "text-primary" : step === "details" ? "text-primary" : "text-muted-foreground"}`}>
                <div className={`w-10 h-10 rounded-full flex items-center justify-center border-2 ${step === "table" ? "border-primary bg-primary text-primary-foreground" : step === "details" ? "border-primary bg-primary/20" : "border-border"}`}>2</div>
              ...
              <div className={`flex items-center gap-2 ${step === "details" ? "text-primary" : "text-muted-foreground"}`}>
                <div className={`w-10 h-10 rounded-full flex items-center justify-center border-2 ${step === "details" ? "border-primary bg-primary text-primary-foreground" : "border-border"}`}>3</div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="bg-card rounded-lg border-2 border-border p-4 mb-8">
                <svg viewBox="0 0 750 480" className="w-full h-auto max-h-[600px]">
                  ...
                  <text x="670" y="150" fill="hsl(var(--muted-foreground))" fontSize="13" fontWeight="bold" textAnchor="middle" className="pointer-events-none" transform="rotate(90, 670, 150)">WC</text>
                  ...
                  <text x="375" y="160" fill="hsl(var(--muted-foreground))" fontSize="13" fontWeight="bold" textAnchor="middle" className="pointer-events-none">ŠANK</text>
                  <text x="115" y="430" fill="hsl(var(--muted-foreground))" fontSize="13" fontWeight="bold" textAnchor="middle" className="pointer-events-none" transform="rotate(90, 115, 430)">ŠANK</text>
                  <text x="55" y="430" fill="hsl(var(--muted-foreground))" fontSize="13" fontWeight="bold" textAnchor="middle" className="pointer-events-none" transform="rotate(90, 55, 430)">ŠANK</text>
                </svg>
              ...
              <div className="mt-12 bg-card p-6 rounded-lg border border-border">
                ...
                <p className="text-sm text-muted-foreground">
                  Za direktne rezervacije nazovite:{" "}
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="bg-card rounded-lg border-2 border-border p-4 mb-8">
                <svg viewBox="0 0 750 480" className="w-full h-auto max-h-[600px]">
                  ...
                  <text x="670" y="150" fill="hsl(var(--muted-foreground))" fontSize="13" fontWeight="bold" textAnchor="middle" transform="rotate(90, 670, 150)">WC</text>
                  <text x="375" y="35" fill="hsl(var(--muted-foreground))" fontSize="14" fontWeight="bold" textAnchor="middle">DJ</text>
                  <text x="375" y="160" fill="hsl(var(--muted-foreground))" fontSize="13" fontWeight="bold" textAnchor="middle">ŠANK</text>
                  <text x="115" y="430" fill="hsl(var(--muted-foreground))" fontSize="13" fontWeight="bold" textAnchor="middle" transform="rotate(90, 115, 430)">ŠANK</text>
                  <text x="55" y="430" fill="hsl(var(--muted-foreground))" fontSize="13" fontWeight="bold" textAnchor="middle" transform="rotate(90, 55, 430)">ŠANK</text>
                </svg>
                ...
                <div className="flex items-center justify-center gap-6 mt-6 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 rounded-full" style={{ backgroundColor: sections.find(s => s.id === selectedSection)?.color }} />
                    <span>Odabrano</span>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              {selectedTable && (
                <div className="bg-primary/10 border border-primary rounded-lg p-6 mb-8 text-center">
                  <p className="text-lg font-semibold mb-2">Odabrani stol: <span className="text-primary text-2xl">#{selectedTable.number}</span></p>
                  <p className="text-muted-foreground">u sektoru {sections.find(s => s.id === selectedTable.section)?.name}</p>
                </div>
              )}
